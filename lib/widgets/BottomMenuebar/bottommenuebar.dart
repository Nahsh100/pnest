...
import 'package:peersnest/widgets/BottomMenuebar/tabItem.dart';
  ...
  Widget _iconRow() {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          _icon(null, 0,
              icon: 0 == state.pageIndex ? AppIcon.home : AppIcon.home,
              isCustomIcon: true),
          _icon(null, 1,
              icon: 1 == state.pageIndex ? AppIcon.search : AppIcon.search,
              isCustomIcon: true),
          _icon(null, 2,
