...
import 'package:peersnest/ui_code/pages/profile/qrcode/dot_indicator.dart';
...
class _ScanState extends State<ScanScreen> with SingleTickerProviderStateMixin {
  ...
  void _onQRViewCreated(QRViewController controller) {
    ...
    controller.scannedDataStream.listen((scanData) {
      ...
      if (result.code.contains("Peersnest/profile/")) {
        isFound = true;
            ...
            children: [
              ClipRRect(
                ...
                child: Container(
                  ...
                  child: QrImage(
                    data: "Peersnest/profile/${widget.user.userId}",
                    embeddedImageStyle:
